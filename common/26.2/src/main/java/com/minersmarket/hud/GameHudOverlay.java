...
public class GameHudOverlay {
    private static final Identifier COIN_TEXTURE =
            Identifier.fromNamespaceAndPath(MinersMarket.MOD_ID, "textures/gui/coin.png");
    ...
    private static void renderPriceEvent(GuiGraphicsExtractor graphics, Minecraft mc,
        ...
        graphics.text(mc.font, header, screenWidth - headerWidth - MARGIN, startY, color, true);
    }

    private static void renderFloatingTexts(GuiGraphicsExtractor graphics, Minecraft mc,
