...
public class MarketMarkerRenderer {
    private static final Identifier MARKER_TEXTURE =
            Identifier.fromNamespaceAndPath(MinersMarket.MOD_ID, "textures/gui/market_marker.png");
    private static final int ICON_SIZE = 16;
    private static final int MIN_DISTANCE = 30;
    private static final int TEXT_COLOR = 0xFFFFFFFF;
    private static final int BG_COLOR = 0x80000000;

    public static void render(GuiGraphicsExtractor graphics, Minecraft mc, int screenWidth, int screenHeight) {
        ...
        graphics.blit(RenderPipelines.GUI_TEXTURED, MARKER_TEXTURE, iconX, iconY, 0, 0, ICON_SIZE, ICON_SIZE, ICON_SIZE, ICON_SIZE);
        ...
        graphics.text(mc.font, fullText, textX, textY, TEXT_COLOR, true);
    }
}
